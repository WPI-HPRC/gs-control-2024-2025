...
void ThroughputDisplayWidget::chooseTarget(RadioPerformanceStat::PacketType target)
{
    ...
    case RadioPerformanceStat::PacketType::Rocket:
        ...
        {
        case RadioPerformanceStat::StatType::Count:
            connection = connect(&Backend::getInstance(), &Backend::rocketCountStats, this, &ThroughputDisplayWidget::countStatsUpdate);
            break;
        case RadioPerformanceStat::StatType::Throughput:
    ...
    case RadioPerformanceStat::PacketType::Payload:
        ...
        {
        case RadioPerformanceStat::StatType::Count:
            connection = connect(&Backend::getInstance(), &Backend::payloadCountStats, this, &ThroughputDisplayWidget::countStatsUpdate);
            break;
        case RadioPerformanceStat::StatType::Throughput:
    ...
    case RadioPerformanceStat::PacketType::Combined:
        ...
        {
        case RadioPerformanceStat::StatType::Count:
            connection = connect(&Backend::getInstance(), &Backend::combinedCountStats, this, &ThroughputDisplayWidget::countStatsUpdate);
            break;
        case RadioPerformanceStat::StatType::Throughput:
